    ...
    if s.count >= 2 {
        for j in 2..<s.count {
            for i in 0..<s.count - j {
                if stringArr[i] == stringArr[i+j] {
                    dpArr[i][i+j] = dpArr[i+1][i+j-1]
                }
            }
        }
    }
...
//let string2 = ""
